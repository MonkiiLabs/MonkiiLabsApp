  ...
  return (
    <div className="space-y-5">
      ...
      <Panel raised className="overflow-hidden">
        <div className="h-16 border-b border-white/10 bg-gradient-to-r from-emerald-900/50 via-emerald-800/20 to-transparent" />
        <div className="-mt-10 p-5">
          <div className="flex items-center gap-4">
            <img
              src={monkiiMark}
              alt=""
              className="h-20 w-20 rounded-2xl border-2 border-emerald-500/40 bg-[#090d0a] object-cover shadow-xl"
            />
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1 flex items-center gap-2">
                <span className="inline-flex items-center gap-1 rounded-md bg-emerald-500/15 px-2 py-0.5 font-mono text-[10px] font-semibold text-emerald-400">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2">
            <code className="rounded-xl border border-white/10 bg-black/40 px-3 py-1.5 font-mono text-xs text-emerald-300">
              {address}
            </code>
            <button
              type="button"
              ...
              className="grid h-8 w-8 place-items-center rounded-xl border border-white/10 bg-white/5 text-slate-300 transition-colors hover:bg-white/10 hover:text-white"
            >
            ...
            {address && (
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-xl border border-white/10 bg-white/5 px-3 py-1.5 font-mono text-xs font-semibold text-emerald-400 transition-colors hover:bg-white/10 hover:text-emerald-300"
              >
        ...
        <dl className="divide-y divide-white/5 px-5">
          {[
            ...
            <div key={row.k} className="flex items-center justify-between py-3 text-xs">
              ...
              <dd className="font-mono font-semibold tabular-nums text-white">{row.v}</dd>
            </div>
          ))}
        </dl>
      </Panel>
      ...
      <Panel>
        ...
        <div className="p-5">
          ...
          <button
            type="button"
            onClick={disconnect}
            className="mt-4 inline-flex items-center gap-2 rounded-xl border border-rose-500/30 bg-rose-500/10 px-4 py-2 font-mono text-xs font-bold uppercase tracking-wider text-rose-300 transition-colors hover:bg-rose-500/20"
          >
