#!/usr/bin/env python3
"""
Monkii Labs Public Repo Sync Script
===================================
Syncs the local `master` branch to the public Open Source repository (monkiilabs/monkiilabsapp)
while rewriting all commit authors & committers to:
  MonkiiLabs <monkiilabs@gmail.com>

Keeps the primary `origin` (NotADeveloper7/monkiilabs) untouched with original credentials.
"""
...
PUBLIC_AUTHOR_NAME = "MonkiiLabs"
PUBLIC_AUTHOR_EMAIL = "monkiilabs@gmail.com"
